...
| `float_precision` | number | `1` | v1.2.0 | The number of decimals used to display data in the legend and the tooltip. It doesn't impact how the data is displayed on the graph |
